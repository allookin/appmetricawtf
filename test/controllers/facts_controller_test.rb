...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { content: @fact.content, number: @fact.number, title: @fact.title, udate: @fact.udate }
    end
  ...
  test "should update fact" do
    patch :update, id: @fact, fact: { content: @fact.content, number: @fact.number, title: @fact.title, udate: @fact.udate }
    assert_redirected_to fact_path(assigns(:fact))
  end
